# **django-mymedia** Installation Instructions

This section contains information about 
how to download and install **django-mymedia** in your system. 
...
inside the ** django-mymedia ** distribution package. 
...
URL is https://github.org/hdknr/django-mymedia


## Install

To install **django-mymedia** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/django-mymedia

The above command will install the latest development release of **django-mymedia**.
